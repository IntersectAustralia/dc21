class AddExtraRifcsFieldsToSystemAndPackage < ActiveRecord::Migration
  def change
    ...
    add_column :system_configurations, :open_access_rights_text, :text, limit: 10000
    add_column :system_configurations, :conditional_access_rights_uri, :text, limit: 10000
    add_column :system_configurations, :conditional_access_rights_text, :text, limit: 10000
    add_column :system_configurations, :restricted_access_rights_uri, :text, limit: 10000
    add_column :system_configurations, :restricted_access_rights_text, :text, limit: 10000
    ...
    add_column :data_files, :access_rights_text, :text, limit: 10000
