...
<p>The processing of file Test_OCR.jpg.txt is now complete.</p>
<p>You can view the file at http://localhost:3000/data_files/#{output.id}</p>
<p>
This file was automatically generated by OCR (#{tesseract_version}).
<br>
Source file name: Test_OCR.jpg
<br>
...
<p>You can view the file at http://localhost:3000/data_files/#{output.id}</p>
<p>
This file was automatically generated by OCR (ABBYY - cloud.ocrsdk.com).
<br>
Source file name: Test_OCR.jpg
<br>
Source file id: #{parent.id}
