Feature: Reset forgotten password
  ...
  Scenario: Reset forgotten password
    ...
    Then I should see "Someone has requested a link to change your password on the DIVER site, and you can do this through the link below." in the email body
  ...
  Scenario: Deactivated user gets an email saying they can't reset their password
    ...
    When I open the email
    Then I should see "Someone has requested a link to change your password on the DIVER site. However your account is not active so you cannot reset your password." in the email body
