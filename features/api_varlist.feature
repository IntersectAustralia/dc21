Feature: Perform listing variables via API
  ...
  Background:
    ...
    And I have data files
      ...
      | mydata7.dat   | 30/11/2011 10:15 | one@intersect.org.au   | 1/6/2010 6:42:01 UTC  | 10/6/2010 18:05:23 UTC | PROCESSED              | blah                        |              | B, C       | My Experiment | HFE Weather Station |             |    | WORKING         | BAGIT       | Conditional        |
